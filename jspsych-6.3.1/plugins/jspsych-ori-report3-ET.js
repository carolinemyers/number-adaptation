...
jsPsych.plugins['ori-report3-ET'] = (function() {
...
for (var i = 0; i < flatPositions.length; i++) {
  html += `<div id="item${i}" class="contMemoryItem" 
        ...
        html += `<span id="contMemoryFixation" style="cursor: pointer; justify-content: center;align-items: center; z-index: 2;">+</span>
             <div id="contMemoryStartTrial" style="position: absolute; z-index: 99999999;
    ...
    if (!has_rotated) {
        ...
        var endTrial = function(trial_data){
            ...
            var trial_data = {
                ...
                'physical_response_angle': reported_angle_contin,
                'reported_ori_angle': reported_color_contin,
                'reported_ori_discrete': cols_clicked,
                'error': trial_errs,
                'which_test': trial.which_test,
                'set_size': trial.set_size,
                ...
                'actual_mask_duration': actual_mask_duration,
                'actual_stim_duration': actual_stim_duration,
                'arrow_orientation': gabor_orientation[0][0],
                'orientation_of_target': gabor_orientation[0][0],
                'allOris': gabor_orientation,
                //"rtNEW": response_time,
                "responseNEW": final_angle,
                "startingAngleNEW": trial.starting_value

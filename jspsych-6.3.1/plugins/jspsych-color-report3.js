 ...
 * Tim Brady Dec. 2020
 * 
 * Edited by CM- BEST VERSION
  */

var continuous_color_css_added = false;

jsPsych.plugins['color-report3'] = (function() {
    ...
    plugin.info = {
        ...
        parameters: {
            ...
            // possibleRadii2: {
            //     type: jsPsych.plugins.parameterType.INT,
            //     pretty_name: 'possibleRadii2',
            //     default: 4,
            //     description: 'possibleRadii2'
            // },
            ...
            num_placeholders: {
                ...
                default: 9,//8, // num locations, or setsize max
...
var outerRadius = 300/2; // trial.radius1;
...
//MASK
        ...
        var showMask = function(ms, callback) {
            if ( trial.mask_display_time > 0 ) {
                ...
                //    SetColor('item'+pos[i], item_mask_colors[i]); 
                    //  SetItem('item'+pos[i]);
                    SetMask('itemX'+pos[i],trial,trial.maskArray[0][i][0], trial);
 ...
 -------------------------------- */ 
     ...
     -------------------------------- */ 
        ...
        var getResponse = function() {
           ...
           for (var i=0; i<trial.set_size; i++) {
            ...
            document.getElementById('item' + pos[i]).style.zIndex = 1000000000;
        ...
        document.getElementById('item' + pos[trial.which_test]).style.zIndex = 1000000000;
    ...
    function SetMask(id, deg, myImg, trial) {
        deg=(deg>=360) ? deg-360:deg;
        deg=(deg<0) ? deg+360:deg;
       document.getElementById(id).style.backgroundImage = `url('${myImg.toString()}')`;
       document.getElementById(id).style.zIndex = 10000001;

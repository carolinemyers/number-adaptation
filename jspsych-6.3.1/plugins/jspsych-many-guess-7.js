...
jsPsych.plugins['many-guess-7'] = (function() {
        ...
        parameters: {
            ...
            */
            ...
            radius2: {
                type: jsPsych.plugins.parameterType.INT,
                pretty_name: 'Where items appear',
                default: [160,80,170, 180, 150, 155,161,162],
                array: true,
                description: 'Radius in pixels of circle items appear along.'
            },
    ...
    plugin.trial = function(display_element, trial) {
     ...
     --------------------------------*/
        if (!continuous_color_css_added) {
            ...
            .crt-container {
                width: 640px; /* Adjust based on desired CRT dimensions */
                height: 480px; /* Adjust for square or desired height */
                overflow: hidden; /* Ensures content outside this area is not visible */
                position: relative; /* Enables absolute positioning inside */
                margin: auto; /* Center container on the page */
                border: 2px solid black; /* Optional: Simulate CRT bezel */
            }
       ...
       #contMemoryBox {
        ...
        var html = `<div class="crt-container">`;
        html += `
        ...
        var startTrial = function() {
          //  removeEventListener('click', startTrial);
            ...
            if (trial.click_to_start) {
                display_element.querySelector('#contMemoryFixation').addEventListener('wheel', function(event) {
        ...
        var showMask = function(ms, callback) {
            if ( trial.mask_display_time > 0 ) {
                ...
                //    SetColor('item'+pos[i], item_mask_colors[i]); 
                    //  SetItem('item'+pos[i]);
                    SetItem('itemX'+pos[i],trial,trial.maskArray[0][i][0], trial);
